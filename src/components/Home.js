        ...
        <section className="relative flex justify-center min-h-screen pt-12 md:pt-32 lg:pt-32 px-8">
          <div className="row">
            <div className="col-12">
              <h1 className="text-6xl text-blue-500 font-bold cursive leading-none lg:leading-snug lg:home-name">Hello, I'm Yenum Opone</h1>
            </div>
            <div className="col-12">
              <p className="text-2xl text-gray-200 pt-12 cursive text-center">Software Developer | Aspiring Game Programmer</p>
            </div>
              <a
