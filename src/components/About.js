          ...
          <div className="grid md:grid-cols-1 lg:grid-cols-1 gap-2">
            ...
            {authorData && 
              ...
              <figure className="md:flex bg-gray-800 rounded-xl p-8 md:p-0 lg:p-0">
                <div className="pt-6 md:p-8 text-center md:text-left space-y-4">
                  <blockquote>
                      <div className="prose lg:prose-xl text-lg font-semibold">
                        {/* {authorData.bio} */}
                        <BlockContent blocks={authorData.bio} projectId="0yaxkdtw" dataset="production"/>
                      </div>
                  </blockquote>
                ...
                <img className="w-32 h-32 lg:w-96 md:w-48 md:h-auto md:rounded-none rounded-full object-cover mx-auto" src={urlFor(authorData.authorImage).url()} alt="" width="768" height="512"/>
              </figure>
            };
            {!authorData &&
              <div>Loading...</div>
