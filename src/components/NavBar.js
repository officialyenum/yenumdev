...
const navigation = [
  ...
  { name: "Anonymous Yellow", href: "/anonymous-yellow", current: false },
];
          ...
          <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
            <div className="relative flex items-center justify-between h-16">
              <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
                <Disclosure.Button className="inline-flex lg:hidden md:hidden items-center justify-center p-2 rounded-md text-gray-400 hover:text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
              ...
              <div className="inset-y-0 left-0 flex items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <div className="hidden lg:block sm:block sm:ml-6">
